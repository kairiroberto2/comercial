...
import hdloja1.pkg1.dao.ClienteDAOImp;
import hdloja1.pkg1.util.EmptyFiledException;
import hdloja1.pkg1.util.RegraDeNegocio;
import java.awt.Color;
import javax.swing.JOptionPane;

public class CadastroClienteJPanel extends javax.swing.JPanel {
    ...
    private javax.swing.JLabel jLabelTituloCadastroCliente;
    private javax.swing.JPanel jPanelBotoes;
    private javax.swing.JPanel jPanelTitulo;
    private javax.swing.JTextField jTextFieldNome;
    // End of variables declaration//GEN-END:variables

    /** Creates new form CadastroClienteJPanel */
    public CadastroClienteJPanel() {
        initComponents();
    } // fim do construtor CadastroClienteJPanel
    ...
    private void initComponents() {
        ...
        jLabelTituloCadastroCliente = new javax.swing.JLabel();
        ...
        jLabelTituloCadastroCliente.setText("Cadastro Cliente");
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanelTituloLayout.createSequentialGroup()
                ...
                .addGroup(jPanelTituloLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanelTituloLayout.createSequentialGroup()
                        .addComponent(jLabelTituloCadastroCliente)
        ...
        jFormattedTextFieldIdcliente.setColumns(11);
        ...
        jFormattedTextFieldIdcliente.setText("1");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jFormattedTextFieldIdcliente))
                .addContainerGap())
        );
    ...
    private void jButtonAnteriorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAnteriorActionPerformed
        // TODO add your handling code here:
        cliente = (Cliente) dAO.consultaSeta(
                jFormattedTextFieldIdcliente.getText(), 2); // consulta registro anterior
    ...
    private void jButtonProximoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonProximoActionPerformed
        // TODO add your handling code here:
        cliente = (Cliente) dAO.consultaSeta(
                jFormattedTextFieldIdcliente.getText(), 3); // consulta proximo registro
    ...
    private void jButtonNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNovoActionPerformed
        // TODO add your handling code here:
        novoPrograma1Teste.consultaClienteJPanel.limpaSelecao();
        limpaCampos();
    ...
    private void jButtonSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSalvarActionPerformed
        ...
        if (cliente != null) {
            ...
            novoPrograma1Teste.consultaClienteJPanel.atualizaTabela(null);
    ...
    private void jButtonExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonExcluirActionPerformed
        ...
        int id = Integer.parseInt(
                jFormattedTextFieldIdcliente.getText());

        int op = JOptionPane.showConfirmDialog(novoPrograma1Teste,
                "Tem certeza que deseja excluir Idcliente " + id + "?");
    ...
    private void jButtonVisualizarTudoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonVisualizarTudoActionPerformed
        // TODO add your handling code here:
        novoPrograma1Teste.exibeJInternalFrameConsultaCliente();
    }//GEN-LAST:event_jButtonVisualizarTudoActionPerformed

    protected void setDados(Cliente cliente) {
        // labels dos campos de preenchimento obrigatorio
        jLabelIdcliente.setForeground(Color.BLACK);
        jLabelPessoa.setForeground(Color.RED);
        //
        jFormattedTextFieldIdcliente.setText("" + cliente.getIdcliente());
        jFormattedTextFieldPessoa.setText("" + cliente.getPessoa());
    } // fim do metodo setDados

    protected Cliente getDados() {
        cliente = null;

        // destaca labels dos campos de preenchimento obrigatorio
        jLabelIdcliente.setForeground(Color.RED);
        jLabelPessoa.setForeground(Color.RED);
        ...
        try {
            regraDeNegocio.validaInteiro(jFormattedTextFieldIdcliente.getText().trim());

            if (!editando && dAO.listaPorID(Integer.parseInt(
                    jFormattedTextFieldIdcliente.getText())) != null) {
                System.out.println(jLabelIdcliente.getText() + " possui valor duplicado!");

                JOptionPane.showMessageDialog(null,
                        jLabelIdcliente.getText() + " possui valor duplicado!");
            ...
            System.out.println(jLabelIdcliente.getText() + " deve ser preenchido!");

            JOptionPane.showMessageDialog(null, jLabelIdcliente.getText() + " deve ser preenchido!");
        } catch (NumberFormatException ex) {
            System.out.println(jLabelIdcliente.getText() + " possui valor incorreto!\n"
                    + "Digite somente numeros inteiros.");

            JOptionPane.showMessageDialog(null, jLabelIdcliente.getText() + " possui valor incorreto!\n"
                    + "Digite somente numeros inteiros.");
        ...
        if (continua) {
            ...
            cliente.setIdcliente(Integer.parseInt(jFormattedTextFieldIdcliente.getText()));
            try {
                cliente.setPessoa(Integer.parseInt(jFormattedTextFieldPessoa.getText()));
            } catch (NumberFormatException ex) {
                cliente.setPessoa(0);
            }
    ...
    public final void restauraCampos(int seta) {
        cliente = (Cliente) dAO.consultaSeta("", seta);
    ...
    protected void limpaCampos() {
        jFormattedTextFieldIdcliente.setText("" + dAO.consultaProximoID());
    ...
    protected void habilitaCampos(boolean habilitadoID, boolean habilitado) {
        jFormattedTextFieldIdcliente.setEditable(habilitadoID);
    ...
    protected void editaRegistro(int id) {
        cliente = (Cliente) dAO.listaPorID(id);
        setDados(cliente);
    ...
    protected void setFrame(NovoPrograma1Teste frame) {
        ...
        dAO = new ClienteDAOImp(frame);

        restauraCampos(1);
    } // fim do metodo setFrame
} // fim da classe CadastroClienteJPanel
