...
public class ConsultaVendaJPanel extends javax.swing.JPanel {

    private NovoPrograma1Teste novoPrograma1Teste;
    private ResultSetTableModel tableModel;
    private static final String CONSULTA_PADRAO =
            "SELECT idvenda, data, cliente"
            + " FROM venda ";
    private static final String ORDER_BY = "ORDER BY idvenda";
    ...
    private javax.swing.JLabel jLabelTituloConsultaVenda;
    private javax.swing.JPanel jPanelBotoes;
    private javax.swing.JPanel jPanelTitulo;
    private javax.swing.JScrollPane jScrollPaneTabelaVenda;
    ...
    /** Creates new form ConsultaVendaJPanel */
    public ConsultaVendaJPanel() {
        initComponents();
    } // fim do construtor ConsultaVendaJPanel
    ...
    private void initComponents() {
        ...
        jLabelTituloConsultaVenda = new javax.swing.JLabel();
        ...
        jScrollPaneTabelaVenda = new javax.swing.JScrollPane();
        ...
        jLabelTituloConsultaVenda.setText("Consulta Venda");
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanelTituloLayout.createSequentialGroup()
                ...
                .addGroup(jPanelTituloLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanelTituloLayout.createSequentialGroup()
                        .addComponent(jLabelTituloConsultaVenda)
        ...
        jScrollPaneTabelaVenda.setViewportView(jTableVenda);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jScrollPaneTabelaVenda, javax.swing.GroupLayout.DEFAULT_SIZE, 523, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jScrollPaneTabelaVenda, javax.swing.GroupLayout.DEFAULT_SIZE, 130, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jTableVendaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableVendaMouseClicked
        // TODO add your handling code here:
        int selRow = jTableVenda.getSelectedRow();

        if (selRow > -1) {
            int id = Integer.parseInt(
                    jTableVenda.getValueAt(selRow, 0).toString());

            if (evt.getClickCount() > 1) {
                novoPrograma1Teste.cadastroVendaJPanel.editaRegistro(id);
                novoPrograma1Teste.exibeJInternalFrameCadastroVenda();
            } else {
                habilitaBotoes(true);
            }
        }
    ...
    private void jButtonExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonExcluirActionPerformed
        ...
        if (selRow > -1) {
            ...
            if (op == JOptionPane.YES_OPTION) {
                novoPrograma1Teste.cadastroVendaJPanel.excluiRegistro(id);
                jTextFieldPesquisa.setText("");
                atualizaTabela(criaConsulta(jTextFieldPesquisa.getText()));
            } // fim do if op
        } // fim do if selRow
    ...
    protected void limpaSelecao() {
        jTableVenda.getSelectionModel().clearSelection();
    ...
    protected String criaConsulta(String palavra) {
        if (jToggleButtonTem.isSelected()) {
            return CONSULTA_PADRAO
                    + "WHERE idvenda LIKE '%" + palavra + "%' "
                    + "OR data LIKE '%" + palavra + "%' "
                    + "OR cliente LIKE '%" + palavra + "%' "
                    + ORDER_BY;
        }
...
} // fim da classe ConsultaVendaJPanel
