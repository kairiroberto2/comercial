...
public class ConsultaFornecedorJPanel extends javax.swing.JPanel {

    private NovoPrograma1Teste novoPrograma1Teste;
    private ResultSetTableModel tableModel;
    private static final String CONSULTA_PADRAO =
            "SELECT idfornecedor, pessoa"
            + " FROM fornecedor ";
    private static final String ORDER_BY = "ORDER BY idfornecedor";
    ...
    private javax.swing.JLabel jLabelTituloConsultaFornecedor;
    private javax.swing.JPanel jPanelBotoes;
    private javax.swing.JPanel jPanelTitulo;
    private javax.swing.JScrollPane jScrollPaneTabelaFornecedor;
    ...
    /** Creates new form ConsultaFornecedorJPanel */
    public ConsultaFornecedorJPanel() {
        initComponents();
    } // fim do construtor ConsultaFornecedorJPanel
    ...
    private void initComponents() {
        ...
        jLabelTituloConsultaFornecedor = new javax.swing.JLabel();
        ...
        jScrollPaneTabelaFornecedor = new javax.swing.JScrollPane();
        ...
        jLabelTituloConsultaFornecedor.setText("Consulta Fornecedor");
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanelTituloLayout.createSequentialGroup()
                ...
                .addGroup(jPanelTituloLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanelTituloLayout.createSequentialGroup()
                        .addComponent(jLabelTituloConsultaFornecedor)
        ...
        jScrollPaneTabelaFornecedor.setViewportView(jTableFornecedor);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jScrollPaneTabelaFornecedor, javax.swing.GroupLayout.DEFAULT_SIZE, 523, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jScrollPaneTabelaFornecedor, javax.swing.GroupLayout.DEFAULT_SIZE, 130, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jTableFornecedorMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableFornecedorMouseClicked
        // TODO add your handling code here:
        int selRow = jTableFornecedor.getSelectedRow();

        if (selRow > -1) {
            int id = Integer.parseInt(
                    jTableFornecedor.getValueAt(selRow, 0).toString());

            if (evt.getClickCount() > 1) {
                novoPrograma1Teste.cadastroFornecedorJPanel.editaRegistro(id);
                novoPrograma1Teste.exibeJInternalFrameCadastroFornecedor();
            } else {
                habilitaBotoes(true);
            }
        }
    ...
    private void jButtonExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonExcluirActionPerformed
        ...
        if (selRow > -1) {
            ...
            if (op == JOptionPane.YES_OPTION) {
                novoPrograma1Teste.cadastroFornecedorJPanel.excluiRegistro(id);
                jTextFieldPesquisa.setText("");
                atualizaTabela(criaConsulta(jTextFieldPesquisa.getText()));
            } // fim do if op
        } // fim do if selRow
    ...
    protected void limpaSelecao() {
        jTableFornecedor.getSelectionModel().clearSelection();
    ...
    protected String criaConsulta(String palavra) {
        if (jToggleButtonTem.isSelected()) {
            return CONSULTA_PADRAO
                    + "WHERE idfornecedor LIKE '%" + palavra + "%' "
                    + "OR pessoa LIKE '%" + palavra + "%' "
                    + ORDER_BY;
        }
...
} // fim da classe ConsultaFornecedorJPanel
