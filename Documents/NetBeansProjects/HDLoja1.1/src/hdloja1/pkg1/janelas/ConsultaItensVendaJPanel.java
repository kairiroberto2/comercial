...
public class ConsultaItensVendaJPanel extends javax.swing.JPanel {

    private NovoPrograma1Teste novoPrograma1Teste;
    private ResultSetTableModel tableModel;
    private static final String CONSULTA_PADRAO =
            "SELECT iditens_venda, produto, venda, preco, quantidade, "
            + "total"
            + " FROM itens_venda ";
    private static final String ORDER_BY = "ORDER BY iditens_venda";
    ...
    private javax.swing.JLabel jLabelTituloConsultaItensVenda;
    private javax.swing.JPanel jPanelBotoes;
    private javax.swing.JPanel jPanelTitulo;
    private javax.swing.JScrollPane jScrollPaneTabelaItensVenda;
    ...
    /** Creates new form ConsultaItensVendaJPanel */
    public ConsultaItensVendaJPanel() {
        initComponents();
    } // fim do construtor ConsultaItensVendaJPanel
    ...
    private void initComponents() {
        ...
        jLabelTituloConsultaItensVenda = new javax.swing.JLabel();
        ...
        jScrollPaneTabelaItensVenda = new javax.swing.JScrollPane();
        ...
        jLabelTituloConsultaItensVenda.setText("Consulta ItensVenda");
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanelTituloLayout.createSequentialGroup()
                ...
                .addGroup(jPanelTituloLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanelTituloLayout.createSequentialGroup()
                        .addComponent(jLabelTituloConsultaItensVenda)
        ...
        jScrollPaneTabelaItensVenda.setViewportView(jTableItensVenda);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jScrollPaneTabelaItensVenda, javax.swing.GroupLayout.DEFAULT_SIZE, 523, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jScrollPaneTabelaItensVenda, javax.swing.GroupLayout.DEFAULT_SIZE, 130, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jTableItensVendaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableItensVendaMouseClicked
        // TODO add your handling code here:
        int selRow = jTableItensVenda.getSelectedRow();

        if (selRow > -1) {
            int id = Integer.parseInt(
                    jTableItensVenda.getValueAt(selRow, 0).toString());

            if (evt.getClickCount() > 1) {
                novoPrograma1Teste.cadastroItensVendaJPanel.editaRegistro(id);
                novoPrograma1Teste.exibeJInternalFrameCadastroItensVenda();
            } else {
                habilitaBotoes(true);
            }
        }
    ...
    private void jButtonExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonExcluirActionPerformed
        ...
        if (selRow > -1) {
            ...
            if (op == JOptionPane.YES_OPTION) {
                novoPrograma1Teste.cadastroItensVendaJPanel.excluiRegistro(id);
                jTextFieldPesquisa.setText("");
                atualizaTabela(criaConsulta(jTextFieldPesquisa.getText()));
            } // fim do if op
        } // fim do if selRow
    ...
    protected void limpaSelecao() {
        jTableItensVenda.getSelectionModel().clearSelection();
    ...
    protected String criaConsulta(String palavra) {
        if (jToggleButtonTem.isSelected()) {
            return CONSULTA_PADRAO
                    + "WHERE iditens_venda LIKE '%" + palavra + "%' "
                    + "OR produto LIKE '%" + palavra + "%' "
                    + "OR venda LIKE '%" + palavra + "%' "
    ...
    protected void setFrame(NovoPrograma1Teste frame) {
        ...
        try {
            ...
            jTableItensVenda.setModel(tableModel);
        } // fim do try
        catch (SQLException sQLException) {
            System.out.println("Ocorreu um erro ao acessar o banco de dados.\n");
            sQLException.printStackTrace();
...
} // fim da classe ConsultaItensVendaJPanel
