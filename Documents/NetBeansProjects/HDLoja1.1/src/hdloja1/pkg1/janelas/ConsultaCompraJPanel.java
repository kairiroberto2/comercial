...
public class ConsultaCompraJPanel extends javax.swing.JPanel {

    private NovoPrograma1Teste novoPrograma1Teste;
    private ResultSetTableModel tableModel;
    private static final String CONSULTA_PADRAO =
            "SELECT idcompra, data, fornecedor"
            + " FROM compra ";
    private static final String ORDER_BY = "ORDER BY idcompra";
    ...
    private javax.swing.JLabel jLabelTituloConsultaCompra;
    private javax.swing.JPanel jPanelBotoes;
    private javax.swing.JPanel jPanelTitulo;
    private javax.swing.JScrollPane jScrollPaneTabelaCompra;
    ...
    /** Creates new form ConsultaCompraJPanel */
    public ConsultaCompraJPanel() {
        initComponents();
    } // fim do construtor ConsultaCompraJPanel
    ...
    private void initComponents() {
        ...
        jLabelTituloConsultaCompra = new javax.swing.JLabel();
        ...
        jScrollPaneTabelaCompra = new javax.swing.JScrollPane();
        ...
        jLabelTituloConsultaCompra.setText("Consulta Compra");
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanelTituloLayout.createSequentialGroup()
                ...
                .addGroup(jPanelTituloLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanelTituloLayout.createSequentialGroup()
                        .addComponent(jLabelTituloConsultaCompra)
        ...
        jScrollPaneTabelaCompra.setViewportView(jTableCompra);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jScrollPaneTabelaCompra, javax.swing.GroupLayout.DEFAULT_SIZE, 523, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jScrollPaneTabelaCompra, javax.swing.GroupLayout.DEFAULT_SIZE, 130, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jTableCompraMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableCompraMouseClicked
        // TODO add your handling code here:
        int selRow = jTableCompra.getSelectedRow();

        if (selRow > -1) {
            int id = Integer.parseInt(
                    jTableCompra.getValueAt(selRow, 0).toString());

            if (evt.getClickCount() > 1) {
                novoPrograma1Teste.cadastroCompraJPanel.editaRegistro(id);
                novoPrograma1Teste.exibeJInternalFrameCadastroCompra();
            } else {
                habilitaBotoes(true);
            }
        }
    ...
    private void jButtonExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonExcluirActionPerformed
        ...
        if (selRow > -1) {
            ...
            if (op == JOptionPane.YES_OPTION) {
                novoPrograma1Teste.cadastroCompraJPanel.excluiRegistro(id);
                jTextFieldPesquisa.setText("");
                atualizaTabela(criaConsulta(jTextFieldPesquisa.getText()));
            } // fim do if op
        } // fim do if selRow
    ...
    protected void limpaSelecao() {
        jTableCompra.getSelectionModel().clearSelection();
    ...
    protected String criaConsulta(String palavra) {
        if (jToggleButtonTem.isSelected()) {
            return CONSULTA_PADRAO
                    + "WHERE idcompra LIKE '%" + palavra + "%' "
                    + "OR data LIKE '%" + palavra + "%' "
                    + "OR fornecedor LIKE '%" + palavra + "%' "
                    + ORDER_BY;
        }
    ...
    protected void setFrame(NovoPrograma1Teste frame) {
        ...
        try {
            ...
            jTableCompra.setModel(tableModel);
        } // fim do try
        catch (SQLException sQLException) {
            System.out.println("Ocorreu um erro ao acessar o banco de dados.\n");
            sQLException.printStackTrace();
...
} // fim da classe ConsultaCompraJPanel
