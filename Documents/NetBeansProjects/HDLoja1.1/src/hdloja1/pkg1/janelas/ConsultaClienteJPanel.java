...
public class ConsultaClienteJPanel extends javax.swing.JPanel {
    ...
    private static final String CONSULTA_PADRAO =
            "SELECT idcliente, pessoa"
            + " FROM cliente ";
    private static final String ORDER_BY = "ORDER BY idcliente";
    ...
    private javax.swing.JLabel jLabelTituloConsultaCliente;
    ...
    /** Creates new form ConsultaClienteJPanel */
    public ConsultaClienteJPanel() {
        initComponents();
    } // fim do construtor ConsultaClienteJPanel
    ...
    private void initComponents() {
        ...
        jLabelTituloConsultaCliente = new javax.swing.JLabel();
        ...
        jLabelTituloConsultaCliente.setText("Consulta Cliente");
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanelTituloLayout.createSequentialGroup()
                ...
                .addGroup(jPanelTituloLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanelTituloLayout.createSequentialGroup()
                        .addComponent(jLabelTituloConsultaCliente)
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jScrollPaneTabelaCliente, javax.swing.GroupLayout.DEFAULT_SIZE, 523, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jScrollPaneTabelaCliente, javax.swing.GroupLayout.DEFAULT_SIZE, 130, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jTableClienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableClienteMouseClicked
        // TODO add your handling code here:
        int selRow = jTableCliente.getSelectedRow();

        if (selRow > -1) {
            int id = Integer.parseInt(
                    jTableCliente.getValueAt(selRow, 0).toString());

            if (evt.getClickCount() > 1) {
                novoPrograma1Teste.cadastroClienteJPanel.editaRegistro(id);
                novoPrograma1Teste.exibeJInternalFrameCadastroCliente();
            } else {
                habilitaBotoes(true);
            }
        }
    ...
    private void jButtonExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonExcluirActionPerformed
        ...
        if (selRow > -1) {
            ...
            if (op == JOptionPane.YES_OPTION) {
                novoPrograma1Teste.cadastroClienteJPanel.excluiRegistro(id);
                jTextFieldPesquisa.setText("");
                atualizaTabela(criaConsulta(jTextFieldPesquisa.getText()));
            } // fim do if op
        } // fim do if selRow
...
} // fim da classe ConsultaClienteJPanel
