...
/*
 * CadastroItensCompraJPanel.java
 *
...
import hdloja1.pkg1.dao.ItensCompraDAOImp;
import hdloja1.pkg1.util.EmptyFiledException;
import hdloja1.pkg1.util.RegraDeNegocio;
import java.awt.Color;
import javax.swing.JOptionPane;

public class CadastroItensCompraJPanel extends javax.swing.JPanel {
    ...
    private javax.swing.JLabel jLabelIditensCompra;
    private javax.swing.JLabel jLabelProduto;
    private javax.swing.JLabel jLabelCompra;
    private javax.swing.JLabel jLabelPreco;
    private javax.swing.JLabel jLabelQuantidade;
    private javax.swing.JLabel jLabelTotal;
    private javax.swing.JLabel jLabelTituloCadastroItensCompra;
    private javax.swing.JPanel jPanelBotoes;
    private javax.swing.JPanel jPanelTitulo;
    private javax.swing.JFormattedTextField jFormattedTextFieldIditensCompra;
    ...
    /** Creates new form CadastroItensCompraJPanel */
    public CadastroItensCompraJPanel() {
        initComponents();
    } // fim do construtor CadastroItensCompraJPanel
    ...
    private void initComponents() {
        ...
        jLabelTituloCadastroItensCompra = new javax.swing.JLabel();
        ...
        jLabelIditensCompra = new javax.swing.JLabel();
        jFormattedTextFieldIditensCompra = new javax.swing.JFormattedTextField();
        ...
        jLabelTituloCadastroItensCompra.setText("Cadastro ItensCompra");
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanelTituloLayout.createSequentialGroup()
                ...
                .addGroup(jPanelTituloLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanelTituloLayout.createSequentialGroup()
                        .addComponent(jLabelTituloCadastroItensCompra)
        ...
        jLabelIditensCompra.setText("Iditens Compra:");

        jFormattedTextFieldIditensCompra.setColumns(11);
        jFormattedTextFieldIditensCompra.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#0"))));
        jFormattedTextFieldIditensCompra.setText("1");
        ...
        jFormattedTextFieldCompra.setColumns(11);
        jFormattedTextFieldCompra.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#0"))));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabelIditensCompra)
                    ...
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jFormattedTextFieldIditensCompra, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButtonAnteriorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAnteriorActionPerformed
        // TODO add your handling code here:
        itensCompra = (ItensCompra) dAO.consultaSeta(
                jFormattedTextFieldIditensCompra.getText(), 2); // consulta registro anterior
    ...
    private void jButtonProximoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonProximoActionPerformed
        // TODO add your handling code here:
        itensCompra = (ItensCompra) dAO.consultaSeta(
                jFormattedTextFieldIditensCompra.getText(), 3); // consulta proximo registro
    ...
    private void jButtonNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNovoActionPerformed
        // TODO add your handling code here:
        novoPrograma1Teste.consultaItensCompraJPanel.limpaSelecao();
        limpaCampos();
    ...
    private void jButtonSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSalvarActionPerformed
        // TODO add your handling code here:
        itensCompra = getDados();

        if (itensCompra != null) {
            if (editando) {
                dAO.altera(itensCompra);
            } else {
                dAO.adiciona(itensCompra);
            }
            ...
            novoPrograma1Teste.consultaItensCompraJPanel.atualizaTabela(null);
    ...
    private void jButtonExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonExcluirActionPerformed
        ...
        int id = Integer.parseInt(
                jFormattedTextFieldIditensCompra.getText());
    ...
    private void jButtonVisualizarTudoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonVisualizarTudoActionPerformed
        // TODO add your handling code here:
        novoPrograma1Teste.exibeJInternalFrameConsultaItensCompra();
    }//GEN-LAST:event_jButtonVisualizarTudoActionPerformed

    protected void setDados(ItensCompra itensCompra) {
        // labels dos campos de preenchimento obrigatorio
        jLabelIditensCompra.setForeground(Color.BLACK);
        jLabelProduto.setForeground(Color.RED);
        jLabelCompra.setForeground(Color.RED);
        jLabelPreco.setForeground(Color.RED);
        jLabelQuantidade.setForeground(Color.RED);
        jLabelTotal.setForeground(Color.RED);
        //
        jFormattedTextFieldIditensCompra.setText("" + itensCompra.getIditensCompra());
        jFormattedTextFieldProduto.setText("" + itensCompra.getProduto());
        jFormattedTextFieldCompra.setText("" + itensCompra.getCompra());
        jFormattedTextFieldPreco.setText(String.format("%.2f", itensCompra.getPreco()));
        jFormattedTextFieldQuantidade.setText(String.format("%.2f", itensCompra.getQuantidade()));
        jFormattedTextFieldTotal.setText(String.format("%.2f", itensCompra.getTotal()));
    } // fim do metodo setDados

    protected ItensCompra getDados() {
        itensCompra = null;

        // destaca labels dos campos de preenchimento obrigatorio
        jLabelIditensCompra.setForeground(Color.RED);
        jLabelProduto.setForeground(Color.RED);
        jLabelCompra.setForeground(Color.RED);
        jLabelPreco.setForeground(Color.RED);
        jLabelQuantidade.setForeground(Color.RED);
        ...
        try {
            regraDeNegocio.validaInteiro(jFormattedTextFieldIditensCompra.getText().trim());

            if (!editando && dAO.listaPorID(Integer.parseInt(
                    jFormattedTextFieldIditensCompra.getText())) != null) {
                System.out.println(jLabelIditensCompra.getText() + " possui valor duplicado!");

                JOptionPane.showMessageDialog(null,
                        jLabelIditensCompra.getText() + " possui valor duplicado!");
            ...
            System.out.println(jLabelIditensCompra.getText() + " deve ser preenchido!");

            JOptionPane.showMessageDialog(null, jLabelIditensCompra.getText() + " deve ser preenchido!");
        } catch (NumberFormatException ex) {
            System.out.println(jLabelIditensCompra.getText() + " possui valor incorreto!\n"
                    + "Digite somente numeros inteiros.");

            JOptionPane.showMessageDialog(null, jLabelIditensCompra.getText() + " possui valor incorreto!\n"
                    + "Digite somente numeros inteiros.");
        ...
        try {
            regraDeNegocio.validaInteiro(jFormattedTextFieldCompra.getText().trim());

            jLabelCompra.setForeground(Color.BLACK);
        } catch (EmptyFiledException ex) {
            System.out.println(jLabelCompra.getText() + " deve ser preenchido!");

            JOptionPane.showMessageDialog(null, jLabelCompra.getText() + " deve ser preenchido!");
        } catch (NumberFormatException ex) {
            System.out.println(jLabelCompra.getText() + " possui valor incorreto!\n"
                    + "Digite somente numeros inteiros.");

            JOptionPane.showMessageDialog(null, jLabelCompra.getText() + " possui valor incorreto!\n"
                    + "Digite somente numeros inteiros.");
        ...
        if (continua) {
            ...
            itensCompra.setIditensCompra(Integer.parseInt(
                    jFormattedTextFieldIditensCompra.getText()));
            try {
                itensCompra.setProduto(Integer.parseInt(
                        jFormattedTextFieldProduto.getText()));
            } catch (NumberFormatException ex) {
                itensCompra.setProduto(0);
            }

            try {
                itensCompra.setCompra(Integer.parseInt(
                        jFormattedTextFieldCompra.getText()));
            } catch (NumberFormatException ex) {
                itensCompra.setCompra(0);
            }

            try {
                itensCompra.setPreco(Double.parseDouble(
                        jFormattedTextFieldPreco.getText().replace(",", ".")));
            } catch (NumberFormatException ex) {
                itensCompra.setPreco(0);
            }

            try {
                itensCompra.setQuantidade(Double.parseDouble(
                        jFormattedTextFieldQuantidade.getText().replace(",", ".")));
            } catch (NumberFormatException ex) {
                itensCompra.setQuantidade(0);
            }

            try {
                itensCompra.setTotal(Double.parseDouble(
                        jFormattedTextFieldTotal.getText().replace(",", ".")));
            } catch (NumberFormatException ex) {
                itensCompra.setTotal(0);
            }
    ...
    public final void restauraCampos(int seta) {
        itensCompra = (ItensCompra) dAO.consultaSeta("", seta);
    ...
    protected void limpaCampos() {
        jFormattedTextFieldIditensCompra.setText("" + dAO.consultaProximoID());
        jFormattedTextFieldProduto.setText("0");
        jFormattedTextFieldCompra.setText("0");
    ...
    protected void habilitaCampos(boolean habilitadoID, boolean habilitado) {
        jFormattedTextFieldIditensCompra.setEditable(habilitadoID);
        jFormattedTextFieldProduto.setEditable(habilitado);
        jFormattedTextFieldCompra.setEditable(habilitado);
    ...
    protected void editaRegistro(int id) {
        itensCompra = (ItensCompra) dAO.listaPorID(id);
        setDados(itensCompra);
    ...
    protected void setFrame(NovoPrograma1Teste frame) {
        ...
        dAO = new ItensCompraDAOImp(frame);

        restauraCampos(1);
    } // fim do metodo setFrame
} // fim da classe CadastroItensCompraJPanel
