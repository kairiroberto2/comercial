...
public class ConsultaCategoriaJPanel extends javax.swing.JPanel {
    ...
    private static final String CONSULTA_PADRAO =
            ...
            + " FROM categoria ";
    private static final String ORDER_BY = "ORDER BY idcategoria";
    ...
    private javax.swing.JLabel jLabelTituloConsultaCategoria;
    private javax.swing.JPanel jPanelBotoes;
    private javax.swing.JPanel jPanelTitulo;
    private javax.swing.JScrollPane jScrollPaneTabelaCategoria;
    ...
    /** Creates new form ConsultaCategoriaJPanel */
    public ConsultaCategoriaJPanel() {
        initComponents();
    } // fim do construtor ConsultaCategoriaJPanel
    ...
    private void initComponents() {
        ...
        jLabelTituloConsultaCategoria = new javax.swing.JLabel();
        ...
        jScrollPaneTabelaCategoria = new javax.swing.JScrollPane();
        ...
        jLabelTituloConsultaCategoria.setText("Consulta Categoria");
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanelTituloLayout.createSequentialGroup()
                ...
                .addGroup(jPanelTituloLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanelTituloLayout.createSequentialGroup()
                        .addComponent(jLabelTituloConsultaCategoria)
        ...
        jScrollPaneTabelaCategoria.setViewportView(jTableCategoria);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jScrollPaneTabelaCategoria, javax.swing.GroupLayout.DEFAULT_SIZE, 523, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jScrollPaneTabelaCategoria, javax.swing.GroupLayout.DEFAULT_SIZE, 130, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jTableCategoriaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableCategoriaMouseClicked
        // TODO add your handling code here:
        int selRow = jTableCategoria.getSelectedRow();

        if (selRow > -1) {
            int id = Integer.parseInt(
                    jTableCategoria.getValueAt(selRow, 0).toString());

            if (evt.getClickCount() > 1) {
                novoPrograma1Teste.cadastroCategoriaJPanel.editaRegistro(id);
                novoPrograma1Teste.exibeJInternalFrameCadastroCategoria();
            } else {
                habilitaBotoes(true);
            }
        }
    ...
    private void jButtonExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonExcluirActionPerformed
        ...
        if (selRow > -1) {
            ...
            if (op == JOptionPane.YES_OPTION) {
                novoPrograma1Teste.cadastroCategoriaJPanel.excluiRegistro(id);
                jTextFieldPesquisa.setText("");
                atualizaTabela(criaConsulta(jTextFieldPesquisa.getText()));
            } // fim do if op
        } // fim do if selRow
    ...
    protected void limpaSelecao() {
        jTableCategoria.getSelectionModel().clearSelection();
    ...
    protected String criaConsulta(String palavra) {
        if (jToggleButtonTem.isSelected()) {
            return CONSULTA_PADRAO
                    + "WHERE idcategoria LIKE '%" + palavra + "%' "
    ...
    protected void setFrame(NovoPrograma1Teste frame) {
        ...
        try {
            ...
            jTableCategoria.setModel(tableModel);
        } // fim do try
        catch (SQLException sQLException) {
            System.out.println("Ocorreu um erro ao acessar o banco de dados.\n");
            sQLException.printStackTrace();
...
} // fim da classe ConsultaCategoriaJPanel
